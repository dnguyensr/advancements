...
Subrequirement.create(requirement_id: req6, part: "e", description: "With a helper and a practice victim, show a line rescue both as tender and as rescuer. (The practice victim should be approximately 30 feet from shore in deep water.)")
